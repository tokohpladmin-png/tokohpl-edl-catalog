...
const collectionCards = [
  { title: 'Laminates', href: '/collections/woods' },
  { title: 'Patterns', href: '/collections/patterns' },
  { title: 'Solids', href: '/collections/solids' },
  { title: 'Promo Items', href: '/collections/promo-items' }
];
        ...
        <div className="soft-card overflow-hidden p-0">
          <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="bg-[#241f1a] p-8 text-white sm:p-10 lg:p-12">
              <p className="eyebrow text-[#d8cbb9]">EDL Materials</p>
              ...
              <p className="mt-5 text-sm leading-7 text-stone-300 sm:text-base">
                EDL began with high pressure laminates and has evolved into a broader ecosystem of interior materials. Browse the catalog and contact tokohpl for availability and project support.
              </p>
              <a href="https://www.edleuro.com/" target="_blank" rel="noreferrer" className="mt-7 inline-flex rounded-full bg-white px-6 py-3 text-sm font-black text-[#241f1a] transition hover:bg-stone-100">
                Visit EDL
              </a>
            </div>
            <div className="relative min-h-[320px] bg-gradient-to-br from-[#d8cbb9] via-[#f3efe7] to-[#aa967b] lg:min-h-full" aria-label="EDL material inspiration" />
          </div>
        </div>
      </section>
    </div>
