          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            <div>
              ...
              <div className="mt-10 space-y-8 text-sm leading-7 text-neutral-700">
                <div>
                  <h2 className="text-lg font-black text-[#241f1a]">TokoHPL</h2>
                </div>
                <div>
                  ...
                  <p>
                    T. 0816 1345 224
                    <br />
                    <a href="mailto:tokohpl.admin@gmail.com" className="font-semibold text-black underline underline-offset-4">tokohpl.admin@gmail.com</a>{" "}
                    |{" "}
