  ...
  return (
    <main className="bg-[#f4f0e8]">
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
        <div className="rounded-none bg-white p-8 shadow-sm ring-1 ring-black/5 md:p-12 lg:p-16">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.35em] text-[#8a4f2b]">Contact</p>

          <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
            <div>
              <h1 className="max-w-3xl text-4xl font-black tracking-tight text-[#241f1a] md:text-6xl">
                Get in Touch
              </h1>
              ...
              <div className="mt-10 space-y-8 text-sm leading-7 text-neutral-700">
                <div>
                  <h2 className="text-lg font-black text-[#241f1a]">CV. VARINDO FORMA HUTAMA</h2>
                  <p className="mt-3">
                    Branz BSD Tower A Unit 3310
                    <br />
                    Jl. BSD Boulevard Parcel 55-F
                    <br />
                    Tangerang 15339 Banten Indonesia
                    <br />
                    T. 0816 1345 224
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    <a href="mailto:tokohpl.admin@gmail.com" className="font-semibold text-black underline underline-offset-4">
                ...
                <div>
                  <h3 className="font-black text-[#241f1a]">Opening Hours</h3>
                  <p>Mon - Fri 09.00 - 17.00</p>
                </div>
              </div>
            </div>

            <aside className="rounded-none bg-[#f4f0e8] p-6 ring-1 ring-black/5 md:p-8">
              ...
              <a
                ...
                className="mt-8 inline-flex rounded-none bg-[#241f1a] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#3a332c]"
              >
                Chat with Us
              </a>
            </aside>
